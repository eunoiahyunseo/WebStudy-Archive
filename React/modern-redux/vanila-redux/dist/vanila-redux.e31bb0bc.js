...
var btnDecrease = document.querySelector("#decrease"); // 액션의 이름을 정해주어야 한다.
// 보통 액션 이름은 문자열 형태로, 주로 대문자로 작성하며 액션 이름은 고유해야 한다.
// < action >

var TOGGLE_SWITCH = "TOGGLE_SWITCH";
var INCREASE = "INCREASE";
var DECREASE = "DECREASE"; // 액션 이름을 활용하여 액션 객체를 만드는 액션 생성 함수를 만들어야 한다.
...
var store = (0, _redux.createStore)(reducer); // render함수 만들기

var render = function render() {
  var state = store.getState(); //토글 처리
